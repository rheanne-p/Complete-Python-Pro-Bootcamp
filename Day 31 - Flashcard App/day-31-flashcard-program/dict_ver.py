...
english_word = ""
try:
    contents = pandas.read_csv("./data/words_to_learn_dict.csv")
...
def next_card():
    global current_word, contents_list, flip_timer
...
def is_known():
    ...
    contents_dataframe.to_csv("./data/words_to_learn_dict.csv")
    next_card()


# ---------------------------- FLIP CARD ------------------------------- #
def flip_card():
    global current_word, english_word, contents_list
    english_word = current_word
    canvas.itemconfig(language_text, text="English", fill="white")
    canvas.itemconfig(vocab_text, text=english_word["English"], fill="white")
